...
export default function Greeting() {
 ...
 const { isDarkMode } = useDarkMode();
  ...
  <div className="container mx-auto flex px-2 py-4 sm:px-5 sm:py-24 items-center justify-center flex-col">
    <div className={`shadow-2xl  rounded-3xl p-2 sm:p-6  xl:p-12 text-center lg:w-2/3 w-auto ${isDarkMode ? 'shadow-slate-700 border-gray-900 text-gray-200 bg-gray-900' : 'shadow-slate-300 border-gray-900 bg-gray-200'} transition-all duration-700 ease-in`}>
